'''
This is an unmodified copy of ipython module IPython.utils.tempdir, which is
itself a backport of the TemporaryDirectly class introduced in Python 3.2 plus
a couple of context manager classes
